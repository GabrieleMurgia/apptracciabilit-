...
sap.ui.define([
  ...
  return Controller.extend("apptracciabilita.apptracciabilita.controller.Screen0", {
    ...
    _handleBackendDown: function (info) {
      ...
      try { BusyIndicator.hide(); } catch (e1) {  }
    ...
    onInit: function () {
      ...
      var sMockUserInfosFile = "mock/UserInfosSet_E_ZEMAF.json";
      ...
      var sOverrideUserTypeWhenReal = "I"; // es: "E"
...
MockData.applyVmFromFile(oVm, {
  ...
  // riallineo flags mock (come già facevi)
  oVm.setProperty("/mock", {
    vendorIdx: iVendorIdx,
    forceStato: sForceStato,
    mockS0: !!bMockS0,
  ...
  console.log("[Screen0][MOCK FILE] applyVmFromFile OK", {
    path: sMockUserInfosFile,
    userId: oVm.getProperty("/userId"),
    userType: oVm.getProperty("/userType")
  });
  ...
  BusyIndicator.hide();
  console.error("[Screen0][MOCK FILE] applyVmFromFile ERROR -> fallback hardcoded", err);

  // fallback: il tuo mock attuale hardcoded
